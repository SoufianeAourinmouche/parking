...
public class BillRepositoryTest extends RepositoryTestHelper {
  ...
  void repositoryTest() {
    ...
    assertEquals(savedParkingSlot.getParking().getName(), savedBill.getParkingSlot().getParking().getName());
  }
}
